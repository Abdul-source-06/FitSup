    ...
    <div class="container mx-auto flex justify-between items-center">
      ...
      >
        <li class="uppercase py-2 hover:scale-110 transform transition-all duration-200">
          <router-link to="/home" class="hover:text-gray-400" @click.native="closeMenu">Home</router-link>
        </li>
        <li class="uppercase py-2 hover:scale-110 transform transition-all duration-200">
          <router-link to="/profile" class="hover:text-gray-400" @click.native="closeMenu">Perfil</router-link>
        </li>
        <li class="uppercase py-2 hover:scale-110 transform transition-all duration-200">
          <router-link to="/Cesta" class="hover:text-gray-400" @click.native="closeMenu">Cesta</router-link>
        </li>
      </ul>
    </div>
  </nav>
